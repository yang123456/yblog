...
export default defineConfig({
  base: '/yblog/',
  title: "程序小兵",
  description: "程序小兵的个人博客",
  appearance: true,
  cleanUrls: true,
  head: [
    ['link', { rel: 'icon', href: '/yblog/images/index/burglar.svg'}],
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: 'Javaᶜⁿ 面试突击', 
            link: 'https://www.javacn.site/'
          },
          {
            text: '蘑菇社区', 
            link: 'https://www.moguit.cn/code'
          },
          {
            text: 'CS-Notes面试笔记', 
      ...
      },
      {
        ...
        items: [
          {
            text: '快捷键',
            link: '/shortcutkey/index'
          },
          {
            text: '素材',
            link: '/wallpaper/index'
          }
        ]
      },
      {
    ...
    sidebar: {
      ...
      'tianyaxunzhi': getSideBarList('/tianyaxunzhi'),
      'shortcutkey': getSideBarList('/shortcutkey'),
      'wallpaper': getSideBarList('/wallpaper')
    },
    ...
    footer: {
      message: '鄂ICP-备2023019165.',
      copyright: '版权所有 © 2024-至今 GuoQiankun'
    }
  }
})
